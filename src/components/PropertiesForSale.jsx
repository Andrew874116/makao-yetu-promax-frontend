...
export default function PropertiesForSale() {
  ...
  useEffect(() => {
    fetch(`${API}/api/get_properties?type=sale`)
      .then(res => res.json())
  ...
  return (
    <div style={{ background: '#0D0D2B', minHeight: '100vh', padding: '2rem' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: '2.5rem', color: '#F5D200', marginBottom: '2rem' }}>💰 Properties for Sale</h1>
